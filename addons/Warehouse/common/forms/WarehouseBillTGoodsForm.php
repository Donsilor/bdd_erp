...
class WarehouseBillTGoodsForm extends WarehouseBillGoodsL
{
    ...
    public function getFooterValues($name = null, $total = [], $defaultValue = 0, $places = 2)
    {
        ...
        $footer_value .= "<span title='{$this->getAttributeLabel($name)}' style='font-size:13px; color: red;'>[".round($value, $places)."]</span>";
        return $footer_value;
    }
...
//        }
    ...
    public function getPlainGoldField()
    {
        $fieldName = [
            ...
            'peiliao_way', 'gold_weight', 'suttle_weight', 'gold_price', 'gold_amount', 'factory_gold_weight',
            'gong_fee', 'piece_fee', 'basic_gong_fee', 'biaomiangongyi', 'biaomiangongyi_fee', 'templet_fee', 'tax_fee', 'tax_amount', 'cert_fee', 'other_fee',
