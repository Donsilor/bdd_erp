...
/**
 * This is the model class for table "warehouse_gold_bill_log".
 *
 * @property int $id ID
 ...
 */
class WarehouseGoldBillLog extends BaseModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return self::tableFullName('warehouse_gold_bill_log');
    }
