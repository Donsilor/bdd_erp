...
class WarehouseBillGoodsA extends BaseModel
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'main_stone_price' => Yii::t('app', '主石单价'),
            ...
            'edition_fee' => Yii::t('app', '版费'),
            'xianqian_price' => Yii::t('app', '镶石费/颗'),
            'peishi_fee' => Yii::t('app', '配石工费'),
            'peishi_weight' => Yii::t('app', '配石重量（ct）'),
