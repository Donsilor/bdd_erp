...
class WarehouseBillGoods extends BaseModel
{
    ...
    {
        return [
            [['id', 'bill_id', 'goods_num', 'order_detail_id', 'put_in_type', 'warehouse_id', 'material', 'pandian_status', 'sort', 'status', 'created_at', 'updated_at'], 'integer'],
            [['bill_id','bill_no', 'bill_type', 'goods_id', 'goods_name', 'style_sn'], 'required'],
