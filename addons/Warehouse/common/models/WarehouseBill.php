...
class WarehouseBill extends BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['id', 'merchant_id', 'bill_status', 'channel_id', 'supplier_id', 'put_in_type', 'order_type', 'goods_num', 'to_warehouse_id', 'to_company_id', 'from_company_id', 'from_warehouse_id', 'is_settle_accounts', 'delivery_type', 'auditor_id', 'audit_status', 'audit_time', 'status', 'creator_id', 'lender_id', 'created_at', 'updated_at'], 'integer'],
    ...
    {
        if(!is_numeric($this->restore_time)) {
            $this->setAttribute('restore_time',$this->restore_time ? strtotime($this->restore_time):0);
        }
