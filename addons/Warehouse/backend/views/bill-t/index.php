                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value'=>function($model) {
                                return Html::a($model->bill_no, ['view', 'id' => $model->id,'returnUrl'=>Url::getReturnUrl()], ['class'=>'openContab','style'=>"text-decoration:underline;color:#3c8dbc"]). ' <i class="fa fa-copy" onclick="copy(\'' . $model->bill_no . '\')"></i>';
                            },
