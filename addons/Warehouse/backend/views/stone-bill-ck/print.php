...
<div class="template">
    <div class="information">
        ...
        <p class="font-bold font-16">石料出库单</p>
        <div class="midd"></div>
        <div class="msg">
            <div class="top">
        ...
        <table class="table">
            ...
            <th class="width-60 algin-center font-bold" >石料名称</th>
            <th class="width-80 algin-center font-bold" >石头编号</th>
            <th class="width-80 algin-center font-bold" >石头规格</th>
            <th class="width-60 algin-center font-bold" >数量(粒)</th>
            <th class="width-50 algin-center font-bold" >下单需求</th>
            <th class="width-80 algin-center font-bold" >单颗石重(ct)</th>
            <th class="width-80 algin-center font-bold" >石头总重（ct)</th>
            <th class="width-65 algin-center font-bold" >石价</th>
            <th class="width-65 algin-center font-bold" >成本金额</th>
            <th class="width-80 algin-center font-bold" >证书号</th>
            <th class="width-120 algin-center font-bold" >备注</th>
            </thead>
            <tbody>
            <?php
