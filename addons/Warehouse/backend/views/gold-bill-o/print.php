...
<div class="template">
    <div class="information">
        ...
        <div class="msg">
            <div class="top">
                <div class="one"><span >工厂名称：</span><span contenteditable="true"><?= $model->supplier->supplier_name ?? '' ?></span></div>
        ...
        <table class="table">
            ...
            <th class="width-80 algin-center font-bold" >货品入库单号</th>
            <th class="width-80 algin-center font-bold" >货品入库金重(g)</th>
            <th class="width-80 algin-center font-bold" >出库金重(g)</th>
            <th class="width-50 algin-center font-bold" >金价</th>
            ...
            <tr class="algin-left">
                ...
                <td class="algin-center padding-5 "><?= $val['t_bill_no']?></td>
                <td class="algin-center padding-5 "><?= $val['t_gold_weight']?></td>
