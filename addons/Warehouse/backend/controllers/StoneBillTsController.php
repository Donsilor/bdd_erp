...
use addons\Warehouse\common\forms\WarehouseStoneBillTsForm;
 ...
 */
class StoneBillTsController extends StoneBillController
{
    use Curd;
    public $modelClass = WarehouseStoneBillTsForm::class;
