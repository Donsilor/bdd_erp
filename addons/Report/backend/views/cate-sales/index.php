                    ...
                    'columns' => [
                        ...
                        [
                                ...
                                'value'=>function($model) {
                                    return Html::a($model->order_sn, ['view', 'id' => $model->id,'returnUrl'=>Url::getReturnTab()], ['class'=>'openContab','style'=>"text-decoration:underline;color:#3c8dbc"]);
                                },
