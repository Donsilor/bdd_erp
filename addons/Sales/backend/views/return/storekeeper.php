...
$this->title = Yii::t('storekeeper', '商品部审核');
...
//                                },
                                'audit' => function($url, $model, $key){
                                    if($model->audit_status == \common\enums\AuditStatusEnum::PENDING
                                        && $model->check_status == \addons\Sales\common\enums\CheckStatusEnum::LEADER) {
                                ...
                                'view' => function($url, $model, $key){
                                    return Html::a('查看', ['return-goods/index', 'return_id', 'id' => $model->id,'returnUrl'=>Url::getReturnUrl()], ['class' => 'btn btn-warning btn-sm']);
                                },
