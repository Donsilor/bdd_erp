...
<div class="box-body nav-tabs-custom">
    <h2 class="page-header"><?php echo $this->title; ?> - <?php echo $model->out_trade_no ?></h2>
            ...
            <div class="box" style="margin:0px">
                ...
                <div class="box-footer text-center">
                    ...
                    if ($model->order_status == OrderStatusEnum::SAVE) {
                        echo Html::edit(['edit', 'id' => $model->id, 'returnUrl' => Url::getReturnUrl()], '编辑', [
                ...
                <div class=" table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><?= Html::edit(['order/ajax-edit-address', 'id' => $model->id, 'returnUrl' => $returnUrl], '编辑', [
                                    'class' => 'btn btn-primary btn-ms',
