...
<div class="modal-header">
    ...
    <div class="modal-body"> 
       <div class="col-sm-12">
           ...
           <div class="row">
                <div class="col-lg-6"><?= $form->field($model, 'mobile')->textInput()->label("手机号码[<sapn style=\"color:red;\">国际批发非必填</sapn>]")->hint("当客户归属渠道为[国际批发]时选填，其它必填")?></div>
                <div class="col-lg-6"><?= $form->field($model, 'email')->textInput()->label("邮箱[<sapn style=\"color:red;\">国际批发必填</sapn>]")->hint("当客户归属渠道为[国际批发]时必填，其它选填")?></div>
           </div>
           <div class="row">
