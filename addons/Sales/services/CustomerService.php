...
class CustomerService extends Service
{
    ...
    {
        return [
            1=>['name'=>'客户信息','url'=>Url::to(['customer/view','id'=>$id,'tab'=>1,'returnUrl'=>$returnUrl])],
            2=>['name'=>'收货地址','url'=>Url::to(['customer-address/index', 'customer_id'=>$id,'tab'=>2,'returnUrl'=>$returnUrl])],
            3=>['name'=>'订单信息','url'=>Url::to(['customer/order', 'customer_id'=>$id,'tab'=>3,'returnUrl'=>$returnUrl])],            
        ];
    }
