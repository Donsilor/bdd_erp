        ...
        <div class="box">
            ...
            <div class="box-body" style="padding:20px 50px">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <?= $form->field($model, 'main_stone_color')->dropDownList(Yii::$app->attr->valueMap(AttrIdEnum::DIA_COLOR),['prompt'=>'请选择']) ?>
                    </div>
                    <div class="col-lg-4">
                        <?= $form->field($model, 'main_stone_clarity')->dropDownList(Yii::$app->attr->valueMap(AttrIdEnum::DIA_CLARITY),['prompt'=>'请选择']) ?>
                    </div>
                    <div class="col-lg-4">
