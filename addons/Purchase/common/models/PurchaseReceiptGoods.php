...
class PurchaseReceiptGoods extends BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['receipt_id', 'xuhao', 'goods_status', 'goods_num', 'style_sex', 'style_channel_id', 'qiban_type', 'peiliao_way', 'jintuo_type', 'is_inlay', 'biaomiangongyi', 'parts_type', 'parts_way', 'parts_num', 'put_in_type', 'to_warehouse_id', 'iqc_reason', 'main_pei_type', 'main_stone_num', 'second_pei_type', 'second_stone_num1', 'second_pei_type2', 'second_stone_num2', 'second_pei_type3', 'second_stone_num3', 'sort', 'status', 'created_at', 'updated_at'], 'integer'],
