    ...
    public function rules()
    {
        return [
            ...
            [['cost_price', 'single_stone_weight','gold_loss', 'gold_price', 'gold_cost_price', 'jiagong_fee', 'xiangqian_fee', 'gong_fee', 'gaitu_fee', 'penla_fee', 'unit_cost_price', 'factory_cost_price',
                ...
                'xianqian_price','penrasa_fee','edition_fee','ke_gong_fee','total_gong_fee','main_stone_cost','second_stone_cost1','second_stone_cost2','peishi_weight','other_fee','pure_gold','lasha_fee','second_stone_cost3','piece_fee'], 'number'],
            [['apply_info'], 'string'],
