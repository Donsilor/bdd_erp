...
<div class="modal-header">
    ...
    <div class="modal-body"> 
       <div class="col-sm-12">
   			<div class="row">
                <div class="col-lg-6"><?= $form->field($model, 'qiban_sn')->textInput(['disabled'=>$model->isNewRecord?null:'disabled'])?></div>
                <div class="col-lg-6"><?= $form->field($model, 'qiban_name')->textInput()?></div>
            </div>
			<div class="row">
                <div class="col-lg-6">
