...
class Style extends BaseModel
{
    ...
    {
        return [
                [['id','factory_id','style_sort','style_material','product_type_id','style_cate_id','style_source_id','style_channel_id','style_sex','is_made', 'merchant_id','sale_volume','goods_num','is_inlay','is_autosn', 'is_gift', 'status', 'audit_status','creator_id','auditor_id','audit_time','created_at', 'updated_at'], 'integer'],
