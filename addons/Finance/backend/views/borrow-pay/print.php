		...
		<div class="container">
			...
			<table border="1" bordercolor="#333" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td>
						<div><?= Yii::$app->formatter->asDate($model->repay_time) ?></div>
					</td>
				</tr>
				<tr>
					<td class="bold">
					...
					<td>
						<div><?= \common\helpers\StringHelper::smalltoBIG($model->borrow_amount)?></div>
					</td>
					<td colspan="2">
						<div><?= $model->borrow_amount?></div>
					</td>
				</tr>

				<tr>
					<td class="bold height_4">借款事由</td>
					<td colspan="3">
						<div><?= $model->borrow_remark ?></div>
					</td>
				</tr>
			</table>
