		...
		<div class="container">
			...
			<table border="1" bordercolor="#333" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
                        <div><?= $model->contract_no?></div>
                    </td>
                    <td class="bold">
                        <div>合同单位及其联系人、联系电话</div>
                    </td>
                    <td>
                        <div><?= $model->contract_info?></div>
                    </td>
                </tr>
                <tr>
                    <td class="bold">
                    ...
                    <td>
                        <div><?= \addons\Finance\common\enums\ContractTypeEnum::getValue($model->contract_type)?></div>
                    </td>
                    <td class="bold">
                        <div>付款类型</div>
                    </td>
                    <td>
                        <div><?= \addons\Finance\common\enums\PaymentTypeEnum::getValue($model->payment_type)?></div>
                    </td>
                </tr>
				<tr>
					<td class="bold">
                ...
                <tr>
                    ...
                    <td>
                        <div><?= $model->last_period_total?></div>
                    </td>
                    <td class="bold">
                        <div>本期累计</div>
                    </td>
                    <td>
                        <div><?= $model->this_period_total?></div>
                    </td>
                </tr>
				<tr>
					<td class="bold">
					...
					<td>
						<div><?= \common\helpers\StringHelper::smalltoBIG($model->this_period_amount)?></div>
					</td>
					<td colspan="2">
						<div><?= $model->this_period_amount?></div>
					</td>
				</tr>
                <tr>
                    <td class="bold">
