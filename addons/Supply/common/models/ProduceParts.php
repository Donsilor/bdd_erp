...
class ProduceParts extends BaseModel
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'cramp_ring' => '扣环',
            'parts_spec' => '配件规格',
            'caigou_time' => '采购时间（记录最新的一次采购时间）',
            'songjian_time' => '已送生产部时间(已送生产部的最新一次时间)',
            'peijian_time' => '配件中时间（操作配件中的最新时间）',
            'caigou_user' => '采购人（操作采购中的人员）',
            'songjian_user' => '送件人（已送生产部操作人员）',
            'remark' => '备注',
            'peijian_user' => '配件人（配件中操作人员）',
            'peijian_status' => '配件状态（需建数据字典）',
            'peijian_remark' => '配件备注',
            'creator_id' => '创建人ID',
            'creator_name' => '创建人',
            'created_at' => '添加时间',
